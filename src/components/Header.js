      ...
      <div className="collapse navbar-collapse" id="navbarColor03">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item active">
            <h1 className="nav-link btn-secondary">
              <strong><Link to="/shopcartReactNoRedux"> Store </Link>
              </strong>
            </h1>
          </li>
        ...
        <form className="form-inline my-2 my-lg-0">
          <div>
            <h1 className="bg-secondary">
              <span
                role="link"
                className="glyphicon glyphicon-briefcase  btn-primary btn-lg"
                onClick={props.clicked}
              >
                <Link to="/bag" className="btn-primary btn-lg">Bag</Link>
              </span>
            </h1>
          </div>
          <table>
            <thead>
              <tr>
                <td>Items:</td>
                <td><h4 className="badge-pill badge-warning"> {props.counter} </h4>
                </td>
              </tr>
              <tr>
                <td>Subtotal</td>
                <td>
                  <h4 className="badge-pill badge-warning">
                    {props.price}$
                  </h4>
                </td>
              </tr>
